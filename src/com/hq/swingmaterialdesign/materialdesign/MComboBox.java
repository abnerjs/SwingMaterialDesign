...
import static com.hq.swingmaterialdesign.materialdesign.MTextField.HINT_OPACITY_MASK;
import static com.hq.swingmaterialdesign.materialdesign.MTextField.LINE_OPACITY_MASK;
...
public class MComboBox<T> extends JComboBox<T> {
    ...
    public static class FieldRenderer<T> extends JComponent implements ListCellRenderer<T> {
        ...
        public FieldRenderer(MComboBox comboBox) {
